...
class nntpreader_nntp {
	...
	private function decodePart($str,$encoding) {
		switch($encoding) {
            case 1: return imap_8bit($str); break;
            case 2: return imap_binary($str); break;
            case 3: return imap_base64($str); break;
            case 4: return quoted_printable_decode($str); break;
